...
export const OFFER: { brand: ProductOffer; shop: ProductOffer } = {
  brand: {
    ...
    hero: {
      ...
      sub: 'New photos of you that follow the trends, already placed on the days you post. We write the hook, caption and hashtags too. No photo shoot. No guessing what to post.',
