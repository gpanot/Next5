...
export const HOME = {
  ...
  products: [
    {
      ...
      title: 'Photos and videos of you, every month.',
      body: 'Paste your Zillow link and show up in your real listings. Get posts for just listed, open house and just sold. Plus UGC videos made by our team.',
      image: `${IMG}/brand/industries/real-estate.png`,
    ...
    },
    {
      ...
      title: 'Your products on a model. Plus videos.',
      body: 'Paste your shop link. Get listing photos for every new product, and UGC videos that sell them.',
  ...
  steps: [
    { title: 'Send your photos', body: 'Three selfies if you are a realtor. Your shop link if you sell on TikTok Shop.' },
    { title: 'Pick a look', body: 'Choose a place and a style. It stays the same every month.' },
    { title: 'Post all month', body: 'Get photos in every size, plus UGC videos made by our team.' },
  ],
  final: {
    title: 'Stop posting the same old photos.',
    body: 'Get 3 free photos today. Paid plans with UGC videos are opening to a small group first.',
    brand: { href: '/start/brand', cta: 'Start free as a realtor' },
    shop: { href: '/start/shop', cta: 'Start free for my TikTok Shop' },
  },
  faq: [
    { q: 'Who is Next5 for?', a: 'Two groups. Real estate agents who need fresh photos and videos of themselves. And TikTok Shop sellers who need photos and videos of their products.' },
    { q: 'What are UGC videos?', a: 'Short videos for TikTok, Reels and Shorts, in the style people film on their phones. Our team makes them for you each month: a hook, a short script and captions on screen. Starter gets 1 a month. Growth gets 4.' },
    { q: 'Are the free photos videos too?', a: 'No. Your first 3 photos are free. UGC videos come with a paid plan.' },
    ...
    { q: 'Can’t I just use ChatGPT?', a: 'You can make one photo. But your face or your product changes each time, you still write every post, and it will not make your weekly videos. Next5 keeps you and your product the same, makes 30 photos at once, writes the hook, caption and hashtags, and our team makes your UGC videos.' },
    { q: 'How much does it cost?', a: 'The realtor plan starts at $29 a month. The TikTok Shop plan starts at $49 a month. Both come with UGC videos. Your first 3 photos are free.' },
    ...
    { q: 'Who owns the photos and videos?', a: 'You do. Use them on social media, your website, your listings and your ads.' },
...
export const BRAND = {
  steps: [
    ...
    { title: 'Get your photos and videos each month', body: 'Pick this month’s theme or one of your listings. Photos are ready in minutes. Our team sends your UGC videos.', image: `${IMG}/brand/themes/just-listed.png` },
  ],
  listings: {
    image: `${IMG}/brand/industries/real-estate.png`,
    points: [
...
export const SHOP = {
  ...
  steps: [
    ...
    { title: 'Get listing packs and videos', body: 'Each week we pick your new stock. You get up to 9 photos per product in TikTok’s upload order, plus a video cover. Our team sends your UGC videos each month.', image: `${IMG}/shop/slider/dress-after.png` },
  ],
  marketplaces: [
