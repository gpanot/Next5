...
// Verbatim copy of the Portrait Clone skill (frontmatter removed), used as the system prompt.
// Source: https://github.com/agentara/skills/blob/main/skills/aigc/portrait-clone/SKILL.md

export const PORTRAIT_CLONE_SKILL = `# Portrait Clone
