...
export const PLANS: Record<PlanId, Plan> = {
  ...
  brand_pro: {
    ...
    product: 'brand',
    name: 'Pro',
    tagline: 'For professionals who post every day.',
  ...
  shop_starter: {
    ...
    product: 'shop',
    name: 'Starter',
    tagline: 'Photograph every new drop.',
    ...
    priority: false,
    mostPopular: false,
    features: ['50 photos every month', '2 shop looks', 'You or 1 Studio model', 'All marketplace formats'],
  },
  shop_pro: {
    id: 'shop_pro',
    product: 'shop',
    name: 'Pro',
    tagline: 'For shops restocking every week.',
