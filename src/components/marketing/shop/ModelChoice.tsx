...
const OPTIONS = [
  ...
  { icon: Sparkles, title: 'Our models', body: 'Fourteen Next5 models — Asian, White, Black, Arabic and Latina — of different ages and body types. Use them on any product. Growth plans get all of them.' },
] as const;
