...
export const HomeHowItWorks = () => (
  <ol className="grid gap-3 sm:grid-cols-3 sm:gap-5">
    {HOME_STEPS.map((step, index) => (
      <AnimateIn key={step.title} as="li" delay={index * 150}>
        <div className="flex h-full flex-col gap-3 rounded-2xl bg-app-panel p-5 shadow-sm ring-1 ring-app-line transition-shadow duration-300 hover:shadow-md sm:p-6">
