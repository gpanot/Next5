...
export const AudienceDoor = ({ door, priority = false }: { door: HomeDoor; priority?: boolean }) => (
  <Link
    href={door.href}
    className="group relative block aspect-[3/4] overflow-hidden sm:aspect-[4/5] rounded-2xl bg-app-sunken shadow-sm ring-1 ring-black/5 transition-shadow duration-300 hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-app-accent sm:rounded-3xl dark:ring-white/10"
  >
    ...
    <div className="absolute inset-0 bg-gradient-to-t from-black/75 via-black/5 via-40% to-transparent" aria-hidden />
