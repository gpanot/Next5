...
const KitSnippet = () => {
  ...
  return (
    <div className="flex flex-col gap-3 rounded-2xl bg-app-panel p-4 shadow-sm ring-1 ring-black/5 dark:ring-white/10">
      <div>
        <p className="flex flex-wrap items-center gap-x-2 gap-y-1 text-[15px] font-semibold text-app-ink">
      ...
      {post.description && <div className="hidden sm:block"><KitLine label="Description" text={post.description} /></div>}
...
export const HomeProof = () => (
  <div className="grid items-center gap-6 lg:grid-cols-[1fr_1.1fr] lg:gap-16">
    <div className="order-2 flex flex-col gap-4 sm:gap-5 lg:order-1">
      ...
      <div className="flex flex-col items-start gap-2">
        <CtaLink href="/start/shop" className="w-full sm:w-auto">{HOME_PROOF.cta}</CtaLink>
