...
export const PromiseBlock = ({ matchPromise }: { matchPromise: string }) => (
  <div className="grid gap-4 md:grid-cols-2">
    <div className="flex flex-col gap-3 rounded-3xl bg-ink p-6 text-white sm:p-8 dark:bg-app-panel dark:ring-1 dark:ring-app-line">
      <Trophy aria-hidden className="h-8 w-8 text-accent" />
      <h3 className="font-display text-[28px] font-medium leading-tight">{OFFER_SHARED.promiseFeedTitle}</h3>
    ...
    <div className="flex flex-col gap-3 rounded-3xl border border-app-line bg-app-panel p-6 sm:p-8">
      ...
      <h3 className="font-display text-[28px] font-medium leading-tight text-app-ink">Every photo looks right, or it’s free</h3>
