...
export function VoicePanel({ token, onVoiceReady, onSkip }: VoicePanelProps) {
  ...
  async function upload(file: File) {
    ...
    const res = await ugcRequest<Partial<UploadResult>>(token, '/api/admin/ugc-lab/voice', { form }).catch(() => null);
    setUploading(false);
