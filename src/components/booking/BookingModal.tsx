  ...
  return (
    <div className="fixed inset-0 z-60 flex items-end justify-center sm:items-center sm:p-6">
      ...
      <div
        ...
        tabIndex={-1}
        className="animate-sheet-in relative flex h-[97vh] w-full max-w-[1060px] flex-col overflow-hidden rounded-t-2xl bg-page shadow-[0_-8px_60px_-12px_rgb(29_21_32/0.5)] outline-none sm:h-[min(88vh,860px)] sm:rounded-2xl sm:shadow-[0_30px_80px_-20px_rgb(29_21_32/0.55)]"
      >
