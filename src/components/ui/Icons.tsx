...
export const FaceIcon = (props: IconProps) => (
  <Svg {...props}>
    ...
    <circle cx="9" cy="10.6" r="0.55" fill="currentColor" stroke="none" />
    <circle cx="15" cy="10.6" r="0.55" fill="currentColor" stroke="none" />
    <path d="M8.7 14.4c1 1 2.1 1.5 3.3 1.5s2.3-.5 3.3-1.5" />
  </Svg>
);

export const CropIcon = (props: IconProps) => (
  <Svg {...props}>
    <path d="M4.5 8.5V5.8A1.3 1.3 0 0 1 5.8 4.5H8.5" />
...
export const EyeIcon = (props: IconProps) => (
  <Svg {...props}>
    <path d="M2.7 12S6.2 5.8 12 5.8 21.3 12 21.3 12 17.8 18.2 12 18.2 2.7 12 2.7 12Z" />
