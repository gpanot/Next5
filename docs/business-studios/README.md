...
| D11–D14 | **(2026-09-15) Mulberry theme, two studios, TikTok Shop studio** | Theme Mulberry Atelier; `/app/brand` + `/app/shop`; Shop $49/$199/$399; shop import via URL scrape + Seller Center export until the TikTok Shop API is approved. Plan: `10-tiktok-shop-plan.md` (P13–P18). |
| D10 | **(2026-09-15) Offer v2 — beat "I can do it with ChatGPT"** | Tiers Starter $29 / Growth $99 / Agency $759; Post Kit, Scroll-Stop Score and Beat-your-feed promise; "built to" claims only, verified testimonials only. See `phases/phase-12-offer.md`. |
